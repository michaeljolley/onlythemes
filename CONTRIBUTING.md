...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/onlythemes.git

**All changes should be based from the `vNext` branch.**

Push to your fork and [submit a pull request](https://github.com/builders-club/onlythemes/compare/) against the `vNext` branch.
